...
const Privacy = () => {
  return (
    <div className='bg-orange-100 py-4 pb-16'>
      <h2 className='text-5xl font-bold text-center text-black my-16'>Privacy</h2>
      <div className='grid grid-cols-1 md:grid-cols-2'>
        ...
        <img src={"https://i.ibb.co/1R2kKW6/p.png"} style={{ width: '100%' }} className='pr-2' alt="" />
      </div>
    </div>
  );
};
